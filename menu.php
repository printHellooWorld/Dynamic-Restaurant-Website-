...
<head>
    ...
    <title>Resto - By Atharva Nevase</title>
            ...
            <div class="row">
                <div class="col-lg-4 menu-wrap">
                    ...
                    <div class="menus d-flex align-items-center">
                        ...
                        <?php
                        $records=mysqli_query($db,"select * from menu2"); // fetch data from database
                        while($data = mysqli_fetch_array($records))
                        {
                            if($data["id"]==1)
                            {
                                ?>
                            <img class="img-fluid" src="<?php echo $data['file_name']; ?>">
                        </div>
                        <div class="text-wrap">
                            <div class="row align-items-start">
                                <div class="col-8">
                                    <h4><?php echo $data['dname']; ?></h4>
                                </div>
                                <div class="col-4">
                                    <h4 class="text-muted menu-price"><?php echo $data['price']; ?></h4>
                                </div>
                            </div>
                            <p>Meat Ball</p>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="footer-widget pr-lg-5 pr-0">
                    ...
                    <p>Built on the idea of reinventing the place where locals go, this neighborhood eatery satisfies diners 
                   with imaginative twists.</br>Visitors can quickly find their nearest location and can access important information such as FAQs about their Food. </p>
            ...
            <div class="col-lg-4">
                <div class="footer-widget px-lg-5 px-0">
                    ...
                    <ul class="list-unstyled open-hours">
                       <li class="d-flex justify-content-between"><span>Monday</span><span>Closed</span></li>
            ...
            <div class="col-lg-4">
                <div class="footer-widget pl-lg-5 pl-0">
                    <h4>Newsletter</h4>
                    <p>For Happy-Hours and more updates from Resto, Share the deal.</p>
                    <form id="newsletter">
            ...
            <div class="col-md-12 d-flex align-items-center">
                <p class="mx-auto text-center mb-0">Copyright 2022 - By Atharva Nevase</p>
            </div>
